<tr>
    <td class="editable text" data-field="firstName"><?php echo $data->first_name ?></td>
    <td class="editable text" data-field="lastName"><?php echo $data->last_name ?></td>
    ...
    <td class="editable select text" data-field="language"><?php echo $data->language ?></td>
